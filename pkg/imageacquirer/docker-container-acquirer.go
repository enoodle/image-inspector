...
func getContainerMeta(source string, client *docker.Client) (
	*containerMeta, error) {
	var err error
...
func getContainerChanges(client *docker.Client, meta *containerMeta, source string, dstPath string) (map[string]struct{}, error) {
