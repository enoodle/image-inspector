...
func (dii *dockerImageAcquirer) dockerPullImage(source string, client *docker.Client) error {
...
func (dii *dockerImageAcquirer) extractImageFromContainer(client *docker.Client, source string) (*docker.Image, string, error) {
	var dstPath string
