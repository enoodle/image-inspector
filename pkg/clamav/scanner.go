...
func (s *ClamScanner) Scan(ctx context.Context, path string, image *docker.Image, filter api.FilesFilter) (api.ScanOutputs, error) {
	...
	return api.ScanOutputs{ScanResults: api.ScanResult{Results: scanResults}}, nil
}
